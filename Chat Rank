...
var players=JSON.parse(FileStream.read("/sdcard/톡방/설정/player.json")); 
function response(room, msg, sender, isGroupChat, replier, imageDB, packageName) {
if(room=="방이름"){
try{
var mydata = JSON.parse(FileStream.read("/sdcard/톡방/"+java.lang.String(imageDB.getProfileImage()).hashCode() +".json")); 
