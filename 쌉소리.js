...
var noSave = ["사진을 보냈습니다.", "동영상을 보냇습니다.", "음성메시지를 보냈습니다.", "카카오톡 프로필", "www.", "샵검색:", "#", "@", "!", "//", "http:", "https:", "빈이", "비니", "빈", "최빈", "봇", "삐뽀", "이모티콘을 보냈습니다.", "!운세", "/", "|", ".", "관리자", "오리방", "지구방", "니셜이", "니셔리", "니셔", "?", "체온", "체오니", "!ChoiB", "최빈공부", "최빈학습", "최빈잊어", "최빈삭제", "!최빈쌉소리", "!최빈수동"]; 
for (var n = 0; n < noSave.length; n++) { 
if (data == noSave[n]) return false;
}
noSave = ["\n", "/", "이모티콘", "사진", "음성메시지", "보이스톡", "페이스톡", "동영상", "카카오톡", "#", "//", "!운세", "삐뽀", "최빈", "체온", "뾰롱", "리보", "가현", "봇", "학습", "빈", "비니", "가혀", "빈은", "최빈이는", "빈이는", "DB", "운세", "/", "관리자", "지원서", "오리방", "지구방", "니셜이", "니셔리", "니셔", "뱁새", "뱁새야", "뱁새봇", "최빈봇", "버전", "업데이트", "DB", "친추", "정지", "-", "씨바", "븅신", "병신", "임티", "운세는", "@", "재현", "유나", "방장", "부방", "!!", "스샷", "캡처",  "(", "씨발", "수동", "자동", ")", "{", "}", "니스", "sat", "SAT", "최빙", "체빈", "채빈", "참치", "닉변", "공지", "깃헙", "내역", "*", "패치", "베타", "업데이트", "부방", "방장", "보노", "닉변", "공지", "게시판", "투표", "펫", "!ChoiB", "최빈공부", "최빈학습", "최빈잊어", "최빈삭제", "!최빈쌉소리", "!최빈수동"];
for (var n = 0; n < noSave.length; n++) { 
