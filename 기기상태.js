...
array[1] = "메모리 여유 사용량 : " + Math.floor(SysMemInfo.freeMemory()/1000000) + "MB";
array[2] = "메모리 사용량 : " + Math.floor(SysMemInfo.totalMemory()/1000000) + "MB";
array[3] = "메모리 전체 용량 : " + Math.floor(SysMemInfo.maxMemory()/1000000000) + "GB";
array[4] = "최대 저장 공간 : " + Math.floor(SysDiskInfo.getTotalSpace()/1000000000) + "GB";
array[5] = "여유 저장 공간 : " + Math.floor(SysDiskInfo.getUsableSpace()/1000000) + "MB";
return array.join("\n");
};
...
replier.reply ("[ 최빈봇 기기 정보 ]\n\n충전 상태 : " + fill[battery-1] + "\n온도 : " + temp + "°c\n배터리 : " + pbattery + "%\n전압 : "+ voltage + "(단위 모름)" + "\nPing : " + Api.getPing("143.59.187.162") + "\u200b".repeat(500) + "\n\n안드로이드 버전 : " + version " + systemInfos());
}
